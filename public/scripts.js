var scripts = (function (exports) {
  ...
  */
  ...
  const dropzone = new $3ed269f2f0fb224b$export$2e2bcd8739ae039(".file-dropzone", { url: "/upload", acceptedFiles: ".docx,.doc" });
  ...
  function showWarning(optionalText = "", delay = 5000) {
  ...
  function showSuccess(optionalText = "", delay = 2500) {
    if (typeof bootstrap === "undefined") return;
  ...
  async function postRequest(url, data, timeout = 30000) {
